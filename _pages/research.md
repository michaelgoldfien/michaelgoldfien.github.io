...
"The Domestic Sources of International Trust" (with Michael Joseph and Roseanne McManus). Forthcoming, <i>American Political Science Review.</i> <a href= "https://michaelgoldfien.github.io/files/Goldfien et al - Domestic Sources of Intl Trust.pdf">Article</a> and <a href= "https://michaelgoldfien.github.io/files/Domestic_Trust_Appendix.pdf">appendix</a>.
<details>
...
"Standing Firm, Breaking Rules: Reputational Spillovers and Entanglement in International Politics" (with Tyler Pratt and Keren Yarhi-Milo). Available on Request. 
<details>
  <summary>Abstract</summary>
...
"After Betrayal: Accommodation, Reputation, and the Political Economy of Discord" (with Ryan Powers, Tyler Pratt, and Jonathan Renshon). Available on Request. 
<details>
  <summary>Abstract</summary>
...
"Nuclear Politics and Conventional War" (with Tyler Bowen, Patrick Hulme, Kendrick Kuo, and So Jin Lee). Available on Request. 
<details>
  <summary>Abstract</summary>
...
"Do Diplomatic Sanctions Work?" (with Nick Anderson). Available on Request. 
<details>
  <summary>Abstract</summary>
Do diplomatic sanctions work? Are the stated goals that a great power sets out to achieve when severing diplomatic relations typically met before relations are reestablished? Despite being an important and commonly-used foreign policy tool—particularly by the United States—there is surprisingly little research that examines the effectiveness of diplomatic sanctions. In this paper, we address this question by looking at U.S. diplomatic relations from 1785 to the present, focusing on all instances in which the U.S. severed or withheld diplomatic ties for coercive purposes. We conduct a “medium-n” analysis of the 26 cases in which the U.S. severed or withheld diplomatic ties with another state for coercive purposes in times of peace. We also conduct five qualitative case studies, to examine the use of diplomatic sanctions in greater detail. We find that diplomatic sanctions are a remarkably unsuccessful tool of American statecraft. In only three or four of these cases (12-15%) does the U.S. achieve anything like a successful outcome, and in all of these “successes,” diplomatic sanctions are supplemented by other—likely more effective—tools of statecraft, such as economic sanctions and military threats or force. We argue that diplomatic sanctions do not work for two key reasons. First, they simply don’t impose sufficient costs to coerce targets to change their behavior. Second, the U.S. frequently asks too much of them—in many cases, effectively calling for regime change in exchange for the resumption of formal diplomatic ties. These arguments and evidence have important implications for research on coercive diplomacy and for U.S. foreign policy.
</details> 

"Reputation and Dissimilar Crises" (with Michael Joseph, Kelly Matush, and Roseanne McManus). Available on Request.
<details>
  <summary>Abstract</summary>
Reputation scholars agree that crises are salient to states for different reasons because the stakes vary widely. They find that if the stakes involved for two crises are increasingly dissimilar, then reputations minimally transfer across them. We study crisis entry models with multi-dimensional stakes and multi-dimensional reputations.
Against the conventional wisdom, we show that observers update their assessments of a state’s resolve most rapidly given a history of very dissimilar past crises via two novel mechanisms for threat perceptions: triangulation, in which observers use the distinctive features of each crisis to grow increasingly confident that they understand their rival’s overall preferences, and retrospective learning, in which observers contextualize the reputational lessons of long-past crises as new but dissimilar crises unfold. While dissimilarities afford rapid learning, the relationship between fighting and reputation is different when crises are dissimilar: fighting can increase or decrease a reputation for resolve, and the direction of effect is heavily conditioned on history; and different audiences draw divergent reputational inferences from the same observed crisis. The model forges a path for the longitudinal analysis of rationalist great power reputation. We find support in a case study of how the U.S. reputation changed throughout the Obama Administration, and varied in the eyes of different beholders, especially in response to the Joint Comprehensive Plan of Action that the United States signed with Iran in 2015.
</details> 

"Situational Variation and Reputation" (with Michael Joseph and Roseanne McManus). Available on Request. 
<details>
  <summary>Abstract</summary>
Scholars have long known that no crises are alike, and fiercely debate whether and under what conditions situational differences ruin states' capacity to develop reputations for resolve. We systematically theorize about the impact of situational differences on rationalist reputation formation. Representing divergent assumptions from different camps, we study controlled comparisons between models where uninformed parties can observe differences across crises (and thus make situational comparisons), and where they cannot. Contrary to the arguments of reputation skeptics, we find that past actions rationally contribute to reputations regardless of whether it is possible to make comparisons among situations. However, reputations develop very differently depending on whether we assume that situations are comparable. Surprisingly, the rationalist predictions about how reputations develop when situations can be compared are different from what reputation proponents generally assume. Our findings also resolve puzzles about threat perceptions, crisis and war onset in the presence of reputational concerns, and the reputational incentives of new leaders by demonstrating that many predictions hinge on whether one assumes situational factors are observable or not. These findings have important implications for empirical research on reputation.
</details> 

"Political Ornithology" (with Soyoung Lee). Early stage.
